...
%英文题目
\Etitle{Research on fast model predictive control algorithms}
% 如果一行写不下，同中文题目设定，一行写不下则写两行，不需要就注释掉
\Etitletl{and the Applications based on embedded systems}
...
% 导师
\supervisor{谢磊\hspace{1em} 教授}

% 合作导师，如果有的话，去掉注释，
\cpsupervisor{Alberto\quad Bemporad}

% 专业名称
\major{控制科学与工程}

% 研究方向
\researchdm{快速模型预测控制算法研究及应用}
